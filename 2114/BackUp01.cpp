...
string searchGrade(); // 학생 성적 검색해주는 함수

void showGrade(); // 학생 성적 보여주는 함수
	...
	for (i = 0; i < 30; i++) {
		if (i == 13) {
			if (flag == 1) {
				...
				gotoxy(45, i);
				ifstream first_grade("second_grade.txt");
				cout << "자신의 학번을 입력하세요 : ";
				cin >> hakbun;
				hakbun2 = to_string(hakbun);
				...
				gotoxy(45, i);
				ifstream first_grade("third_grade.txt");
				cout << "자신의 학번을 입력하세요 : ";
				cin >> hakbun;
				hakbun2 = to_string(hakbun);
